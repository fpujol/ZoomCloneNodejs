...
navigator.mediaDevices.getUserMedia({
  video: true,
  audio: true
}).then(stream => { //On a resolved promise we receive a stream from the browser media
  ...
  myPeer.on('call', call => {
    ...
    call.on('stream', remoteUserVideoStream => { //Add video when we receive the remote stream
